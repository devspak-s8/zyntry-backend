        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#7c3aed,#6366f1);padding:32px 32px 28px;text-align:center;">
              ...
              <h1 style="color:#ffffff;margin:0 0 8px;font-size:22px;font-weight:700;letter-spacing:-0.3px;">Verify Your Email</h1>
              <p style="color:rgba(255,255,255,0.85);margin:0;font-size:14px;line-height:1.5;">Welcome to Zyntra, {display_name}!</p>
            </td>
          </tr>
          <tr>
            <td style="padding:32px;">
              <p style="color:#334155;margin:0 0 16px;font-size:14px;line-height:1.6;">Your verification code is:</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:20px 0;">
                    <table role="presentation" cellpadding="0" cellspacing="0" style="background:#f1f5f9;border-radius:12px;border:2px dashed #cbd5e1;">
                      <tr>
                        <td style="padding:16px 32px;text-align:center;">
                          <span style="font-size:32px;font-weight:800;letter-spacing:6px;color:#1e293b;font-family:'SF Mono','Fira Code','Consolas',monospace;">{token}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <p style="color:#64748b;margin:0 0 24px;font-size:13px;line-height:1.5;">Enter this code on the verification page to confirm your email address. This code expires in 24 hours.</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="{app_url}/verify-email?token={token}" style="display:inline-block;background:#7c3aed;color:#ffffff;padding:14px 28px;border-radius:10px;font-size:14px;font-weight:700;text-decoration:none;box-shadow:0 4px 12px rgba(124,58,237,0.3);">Verify Email Now</a>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background-color:#f8fafc;padding:20px 32px;border-top:1px solid #e2e8f0;">
              <p style="color:#94a3b8;margin:0;font-size:12px;line-height:1.5;">If you didn't create a Zyntra account, you can safely ignore this email.</p>
            </td>
          </tr>
        </table>
      </td>
