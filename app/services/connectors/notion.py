...
class NotionConnector(BaseConnector):
    async def connect(self) -> dict:
        self._status = {"status": "connected", "message": "Notion connected"}
        return self._status

    async def test(self) -> dict:
        # TODO: validate Notion integration token
        return {"success": True, "message": "Notion connection test stub"}

    async def discover(self) -> dict:
        # TODO: list Notion pages/databases via Notion API
    ...
    async def refresh(self) -> dict:
        # TODO: refresh Notion integration token
