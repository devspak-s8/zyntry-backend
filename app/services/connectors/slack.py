...
class SlackConnector(BaseConnector):
    async def connect(self) -> dict:
        self._status = {"status": "connected", "message": "Slack connected"}
        return self._status

    async def test(self) -> dict:
        # TODO: validate Slack bot token
        return {"success": True, "message": "Slack connection test stub"}

    async def discover(self) -> dict:
        # TODO: list Slack channels/messages via Slack API
