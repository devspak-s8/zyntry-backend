...
class PostgresConnector(BaseConnector):
    async def connect(self) -> dict:
        self._status = {"status": "connected", "message": "PostgreSQL connected"}
        return self._status

    async def test(self) -> dict:
        # TODO: open connection pool and run SELECT 1
        return {"success": True, "message": "PostgreSQL connection test stub"}

    async def discover(self) -> dict:
        # TODO: list tables/schemas via SQL information_schema
    ...
    async def sync(self, options: dict | None = None) -> dict:
        ...
        # TODO: trigger PostgreSQL table indexing
    ...
    async def refresh(self) -> dict:
        # TODO: refresh connection if needed
        return {"success": True, "message": "Connection refreshed stub"}
