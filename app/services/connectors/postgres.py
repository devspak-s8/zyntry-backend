...
registry.register("cockroachdb", PostgresConnector)
registry.register("neon", PostgresConnector)
registry.register("amazon_aurora", PostgresConnector)
registry.register("postgis", PostgresConnector)
